...
\usepackage{afterpage} % Used for blank pages
\newcommand\blankpage{%
    \null
    \thispagestyle{empty}%
    \addtocounter{page}{-1}%
...
\usepackage[a4paper, margin=1in, marginparwidth=0.1in, marginparsep=0.1in]{geometry} % Document margins %JS add margin info
